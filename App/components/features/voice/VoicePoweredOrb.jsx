...
/**
 * WebGL voice-reactive orb. Reacts to mic input (when enableVoiceControl is on)
 * by spinning faster and warping. `hue` shifts the palette per call status.
 * Ported to JSX from the SIH-2 voice agent interface.
 */
